...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ess="http://www.enterprise-architecture.org/essential/errorview">
	...
	<!-- 31.07.2018	JWC i18N version of catalogue -->
	...
	<xsl:variable name="instanceClassName" select="'Group_Actor'"/>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<p><xsl:value-of select="eas:i18n('Please select a group actor to navigate to the required view')"/>.</p>
		...
		<div class="catalogItems">
			<ul>
				<xsl:apply-templates mode="RenderInstance" select="$theInstances[((starts-with(own_slot_value[slot_reference = 'name']/value, $letter)) or (starts-with(own_slot_value[slot_reference = 'name']/value, $letterLow)))]">
					<xsl:sort order="ascending" select="lower-case(own_slot_value[slot_reference = 'name']/value)"/>
				</xsl:apply-templates>
			</ul>
		</div>
